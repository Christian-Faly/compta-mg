...
begin
  ...
  showMessage('Operation1 terminée');
end;
...
begin
  case strtoint(copy(RRembTVA_FacturePeriode.Value,6,2)) of
    ...
    2 :RRembTVA_FactureMois.Value:='Février';
