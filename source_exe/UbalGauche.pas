...
begin
  ...
  //{1er sté}  DaConsolide.BalConsolideee.first; QRLabel28.Caption :=DaConsolide.BalConsolideeeNom.Value ;
  //{2ème sté} DaConsolide.BalConsolideee.Next;  QRLabel24.Caption :=DaConsolide.BalConsolideeeNom.Value ;
  //{3ème sté} DaConsolide.BalConsolideee.Next;  QRLabel30.Caption :=DaConsolide.BalConsolideeeNom.Value ;
  //{4ème sté} DaConsolide.BalConsolideee.Next;  QRLabel46.Caption :=DaConsolide.BalConsolideeeNom.Value ;
