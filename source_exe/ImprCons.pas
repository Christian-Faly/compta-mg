...
procedure TFBalCoP2.QRBand8BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var i:integer;
begin
...
procedure TFBalCoP2.QuickRep1BeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var i:integer;
begin
  QRGroup2.Height:=0;
...
procedure TFBalCoP2.QRBand3BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFBalCoP2.QRBand10BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFBalCoP2.QRBand9BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFBalCoP2.QRBand12BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFBalCoP2.QRBand1BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFBalCoP2.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFBalCoP2.QRBand1AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  QRExpr52.Reset;
  QRExpr57.Reset;
...
procedure TFBalCoP2.QRBand3AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  QRExpr45.Reset;
  QRExpr47.Reset;
...
procedure TFBalCoP2.QRBand10AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  QRExpr48.Reset;
  QRExpr49.Reset;
...
procedure TFBalCoP2.QRBand9AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  QRExpr50.Reset;
  QRExpr51.Reset;
...
procedure TFBalCoP2.QRBand12AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
  QRExpr76.Reset;
  QRExpr79.Reset;
...
procedure TFBalCoP2.QRBand2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
var i:integer;
begin
  for i:=1 to 7 do
