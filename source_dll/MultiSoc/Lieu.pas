...
begin
  Nochange:=true;
  if ajout then DObjet.Lieu.insert
  else DObjet.Lieu.edit;
  try
    DObjet.Lieucode.Value:=edit1.text;
    DObjet.LieuLieu.Value:=edit2.text;
    DObjet.Lieu.post;
  except
...
begin
  ...
  edit1.text:=DObjet.Lieucode.Value;
  edit2.text:=DObjet.LieuLieu.Value;
end;
